...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <a className="font-bold sm:text-2xl text-xl cursor-pointer">Book Store.</a>
  </div>
  ...
  <label className="px-3 py-2 bg-white rounded-md flex items-center gap-2 ">
  <input type="text" className="grow bg-white outline-none" placeholder="Search" />
...
{/* search bar */}
  ...
  {/* login button */}
  <div >
    <a className="py-2 px-3 p-2 rounded-md bg-black text-white cursor-pointer">Login</a>
  </div>
</div>
</div>
   </div>

...
function Navbar() {
  ...
  return (
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 fixed top-0 left-0 right-0 ${
          sticky
            ? "sticky-navbar shadow-md bg-[#f5f5f5] duration-300 transition-all ease-in-out"
            : ""
        }`}
      >
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className="font-bold sm:text-2xl text-xl cursor-pointer">
              <span className="font-bold text-black text-[35px]">B</span>ook
              <span className="font-bold text-red-500 text-[35px]">S</span>
              <span className="text-red-500">tore</span>
            </a>
          </div>

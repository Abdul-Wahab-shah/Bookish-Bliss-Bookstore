          ...
          <div className="   md:space-y-11 space-y-6">
            ...
            <div>
              <label className="py-3 px-3 border rounded-md  flex items-center gap-2 bg-white" >
                ...
                <input type="email" className="grow outline-none bg-white text-slate-600 text-[14px]" placeholder="Email" />
              </label>
            </div>
          </div>
          <button className="btn mt-6 bg-black text-white  border-none hover:bg-red-500">Secondary</button>
        </div>
